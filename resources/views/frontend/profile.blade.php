                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            ...
                            <a id="upload_btn" href="" class="btn btn-sm btn-default mr-4">{{ __('change') }}</a>
                            <form id="form" style="display:none" action="/profile" method="POST" enctype="multipart/form-data">
                                @csrf
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        <div class="row">
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    <div>
                                        <span class="heading">{{count($user->courses)}}</span>
                                        <span class="description">{{ __('Courses') }}</span>
                                    </div>
                                    <div>
                                        <span class="heading">{{count($user->tracks)}}</span>
                                        <span class="description">{{ __('Tracks') }}</span>
                                    </div>
                                    <div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="{{$user->email_verified_at ? 'text-success' : 'text-danger'}}">
                                <i class="ni education_hat mr-2"></i>{{$user->email_verified_at ? 'Verified' : 'Unverified'}}
                            </div>
                        </div>
                    </div>
                </div>
