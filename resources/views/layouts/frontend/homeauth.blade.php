        ...
        <div class="single-popular-course">
            ...
            <div class="details">
              <div class="d-flex justify-content-between mb-20">
                <a href="/track/{{ $course->track->name }}#">
          ...
          <div class="offset-lg-1 col-md-6 video-left">
            <div class="owl-carousel video-carousel">
              ...
              <div><a href="#">
                ...
                @else
                <a href="/courses/{{$freecourse->slug}}">
                  <img style="height:369px" class="img-fluid" src="{{ asset('images') }}/default.jpg" alt="" />
                </a>
                @endif
                <a href="/courses/{{$freecourse->slug}}">
                ...
                <h5 class="text-white mb-20 mt-30"><strong class="text-warning">Track Name : </strong><a class="text-white" href="/track/{{ $freecourse->track->name }}"> {{$freecourse->track->name}}</a></h5>
              </a>
              </div>
              @endforeach
    ...
    <div class="container-fluid">
      <div class="row justify-content-center section-title">
        <div class="col-lg-12">       
          ...
          <p>
            Choose from our awsome online video courses with new additions published every month just for you . <span><a href="/courses">View More</a></span>
          </p>
        </div>
      </div>
      ...
      <div class="owl-carousel popuar-course-carusel">
        ...
        <div class="single-popular-course">
            ...
            <div class="details">
              <div class="d-flex justify-content-between mb-20">
                <a href="/track/{{ $course->track->name }}"><p class="name">{{$course->track->name}}</p></a>
  ...
  <!-- ================ End Popular Course Area ================= -->
	...
	<section class="top-category-widget-area pt-90 pb-90 ">
      ...
      <h4 class="mb-3 mt-4">Featured courses in : <a href="/track/{{ $track->name }}">{{$track->name}}</a></h4>
			<div class="row">
        ...
        <div class="famous-tracks">
          ...
          <h4>Popular topics for you :</h4>
              <div class="row text-center justify-content-center mt-3">
                ...
                <div class="col-lg-2 col-md-3 col-xs-6  tracks"><a class="btn track-name" href="/track/{{ $famous_track->name }}">{{ $famous_track->name }}</a></div>
                @endforeach
              </div>
        </div>
